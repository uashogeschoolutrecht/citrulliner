...
theme_panel <- function (base_size = 30,
  ...
  theme_grey(base_size = base_size,
    ...
    theme(# Set text size
      ...
      legend.key = element_rect(size = 17, colour = "white"),
      ...
      axis.text.x = element_text(margin=margin(2,0,0,0, unit = "pt"),
                                 color = "black", size = 15),
      axis.text.y = element_text(margin=margin(0,2,0,0, unit = "pt"),
                                 color = "black", size = 15),
